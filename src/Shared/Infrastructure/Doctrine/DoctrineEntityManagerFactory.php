...
use TechyCode\Shared\Infrastructure\Doctrine\Dbal\DbalCustomTypesRegistrar;
...
final class DoctrineEntityManagerFactory
{
    private static array $sharedPrefixes = [
        __DIR__ . '/../../../Shared/Infrastructure/Persistence/Mappings' => 'TechyCode\Shared\Domain',
    ];
    ...
    private static function databaseExists($databaseName, PostgreSqlSchemaManager $schemaManager): bool
    {
